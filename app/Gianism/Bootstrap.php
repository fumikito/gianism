...
class Bootstrap extends Pattern\Singleton {
	...
	public function register_assets() {
		wp_register_style( 'ligature-symbols', $this->url . 'assets/compass/stylesheets/lsf.css', [], '2.11' );
		...
		wp_register_script( $this->name . '-notice-helper', $this->url . 'assets/compass/js/public-notice' . ( WP_DEBUG ? '' : '.min' ) . '.js', array(
