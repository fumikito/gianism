...
<table class="form-table">
	<tbody>
	<tr>
		<th><label><?php printf( __( 'Connect with %s', 'gianism' ), 'LINE' ); ?></label></th>
		<td>
			<?php $this->switch_button( 'line_enabled', $this->option->is_enabled( 'line'), 'line_enabled' ) ?>
			<label>
			<p class="description">
				<?php printf( __( 'You have to create %1$s App <a target="_blank" href="%2$s">here</a> to get required information.', 'gianism' ), "LINE", "https://developers.line.me/" ); ?>
				<?php printf( __( 'See detail at <a href="%1$s">%2$s</a>.', 'gianism' ), $this->setting_url( 'setup' ), __( 'How to set up', 'gianism' ) ); ?>
			</p>
		</td>
	</tr>
	<tr>
		<th><label for="line_channel_id"><?php _e( 'Channel ID', 'gianism' ); ?></label></th>
	...
	<tr>
		<th><label for="line_channel_secret"><?php _e( 'Channel Secret', 'gianism' ); ?></label></th>
	...
	<tr>
		<th><label><?php esc_html_e( 'Retrieve Email', 'gianism' ); ?></label></th>
		<td>
			<?php $this->switch_button( 'line_retrieve_email', $instance->line_retrieve_email, 1 ) ?>
			<label>
			<p class="description">
				<?php printf( __( 'You need registration to retrieve user email. Go to <a target="_blank" href="%1$s">LINE developer</a> and submit request.', 'gianism' ), 'https://developers.line.me/' ); ?>
			</p>
		</td>
	</tr>
	</tbody>
